function mostrarAlertaPersonalizada(mensaje, tipo = 'info', titulo = 'Ofertas eliminadas') {
  // Evitar duplicados
  ...
  Object.assign(alerta.style, {
    ...
    color: 'white',
    borderRadius: '12px',
    borderLeft: `5px solid ${colores[tipo].borde}`,
  ...
  const toastTex = alerta.querySelector('.toast-text'); Object.assign(toastTex.style, { width: "100%" });
